...
start "PTP Local" "%JAVA_HOME%\bin\javaw.exe" -cp %PTP_JAR% cc.co.phptunnelproxy.ptplocal.ui.SwingLauncher %*
goto END

:NOJAVAHOME
start "PTP Local" javaw.exe -cp %PTP_JAR% cc.co.phptunnelproxy.ptplocal.ui.SwingLauncher %*
goto END
